...
const MovieForm = () => {
  ...
  return (
    <div className="flex justify-center items-center h-screen bg-[#e5e8f0]">
      <div className="flex flex-col items-center flex-wrap w-[80%] md:h-[90%] sm:h-[90%] max-sm:h-[60%] max-sm:w-[90%] bg-white rounded-3xl shadow-lg">
        <div className="text-2xl my-3 font-bold">
          <h2>Add a New Movie</h2>
        </div>
        <form
          onSubmit={handleSubmit}
          className="flex flex-col items-center h-[90%] w-1/2"
        >
          <div className="flex flex-col w-[80%] gap-3 h-full">
            <div className="flex justify-center text-xl font-semibold mt-4">Enter Movie Information</div>
          ...
          <button
            type="submit"
            className="bg-success h-[10%] w-[50%] mt-4"
          >
            Add Movie
          </button>
        </form>
