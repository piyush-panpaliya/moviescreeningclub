...
const MovieForm = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    axios
      .post(`/api/movie/add-movies`, formData)
      .then((res) => {
  ...
  return (
    <div className="flex justify-center items-center h-screen bg-[#e5e8f0]">
      <div className="flex flex-col items-center flex-wrap w-[80%] md:h-[90%] sm:h-[90%] max-sm:h-[90%] max-sm:w-[90%] bg-white rounded-3xl shadow-lg overflow-auto">
