...
const Foram2 = () => {
	...
	const submitHandler = async (e) => {
		...
		try {
			const response = await api.post(`/payment/tempPayment`, {
				...data,
			})
							...
							<div className='flex justify-evenly my-8'>
								...
								<div className='flex flex-col justify-between w-1/2'>
									...
									<span className='text-sm mt-4'>
										*scan the QR code to get the subscription and then fill the
										form at the bottom of the page to verify the membership
									</span>
								</div>
							</div>
