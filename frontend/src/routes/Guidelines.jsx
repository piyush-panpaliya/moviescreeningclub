export default function Guidelines() {
  return (
    <div className="flex flex-col gap-6 font-monts">
      ...
      <span className="border-b-2">
        <p className="ml-4">
          2. Enter your institute email ID which you will be using to signup on
      ...
      <span className="border-b-2">
        <p className="ml-4">
          3. Complete the registration process by entering details such as your
      ...
      <span>
        <p className="ml-4">
          4. Your account has been created, now return to the homepage and log
      ...
      <span className="border-b-2">
        <p className="ml-4">
          ...
          {/* 4. Once logged in, you&lsquo;ll be greeted
          with posters featuring the movies scheduled for the screening. Click
